 ...
 */
class League extends \App\Entity\League implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\League' . "\0" . 'id', '' . "\0" . 'App\\Entity\\League' . "\0" . 'name', '' . "\0" . 'App\\Entity\\League' . "\0" . 'teams'];
        }
     ...
     * {@inheritDoc}
     */
    public function addTeam(\App\Entity\Team $team): void
    {
