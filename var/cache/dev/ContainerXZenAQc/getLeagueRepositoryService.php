...
// Returns the private 'App\Repository\LeagueRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LeagueRepository.php';

return $this->privates['App\Repository\LeagueRepository'] = new \App\Repository\LeagueRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
