...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\LeagueRepository' => function () {
    return ($this->privates['App\Repository\LeagueRepository'] ?? $this->load('getLeagueRepositoryService.php'));
}, 'App\\Repository\\TeamRepository' => function () {
    return ($this->privates['App\Repository\TeamRepository'] ?? $this->load('getTeamRepositoryService.php'));
}))));
